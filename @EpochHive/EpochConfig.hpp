...
// Time based
StaticDateTime[] = {0,0,0,4,0}; // {0,0,0,8,0} would forces the server to start at 8am each time it is started while allowing the year, month and day to stay real time. Any values left at 0 will result in no change.
...
vehicleLockTime = 7200; // Controls how many seconds it takes to allow another person/group to unlock vehicle.
allowedVehiclesList[] = {
...
{"C_Van_01_box_EPOCH",7},
{"C_Van_01_transport_EPOCH",7},
{"B_G_Van_01_fuel_F",3},
{"I_G_Van_01_fuel_F",3},
...
{"C_Heli_light_01_speedy_F",3},
{"I_Heli_Transport_02_EPOCH",4},
...
{"C_Heli_light_01_sheriff_F",4},
{"C_Heli_light_01_furious_F",4},
{"C_Heli_light_01_digital_F",4},
{"mosquito_epoch",4},
